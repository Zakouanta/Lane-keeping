function[xmeasure,x_mpc,y_mpc] = SolveMPC(Ad,Bd,n,m,x0, ...
        ...
        % List of constraints bounds 
        list_max =[];
        list_max2 = [];
        
        % Initialise variable to store cost 
        previous_cost = Inf;

        % Initialize iteration stopped 
        broken_ii = 0;
 ...
 for ii = 1:mpciterations
    ...
    % Verify if the system is optimisable
